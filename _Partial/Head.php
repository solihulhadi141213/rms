...
<meta content="<?php echo "$app_keyword_show"; ?>" name="keywords">
<!-- Favicons -->
<link href="assets/img/<?php echo "$app_favicon"; ?>" rel="icon">
<link href="assets/img/<?php echo "$app_favicon"; ?>" rel="apple-touch-icon">
<!-- Google Fonts -->
