<?php
    ...
    $report_code        = validateAndSanitizeInput($_POST['report_code'] ?? '');
    $report_description = validateAndSanitizeInput($_POST['report_description'] ?? '');
    $report_sys         = validateAndSanitizeInput($_POST['report_sys'] ?? '');
