...
function ShowConnectionTable() {
    $.ajax({
        type    : 'POST',
        url     : '_Page/SettingPacs/TabelSettingPacs.php',
...
$(document).ready(function() {
    ...
    */
    ...
    $('#ProsesTambah').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/SettingPacs/ProsesTambah.php',
            dataType: 'json',
            data    : ProsesTambah,
    ...
    $(document).on('click', '.modal_detail', function () {
        ...
        //tangkap data 'id_connection_pacs' dan buat variabel
        var id_connection_pacs   = $(this).data('id');
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingPacs/FormDetail.php',
            data        : {id_connection_pacs: id_connection_pacs},
            success     : function(data){
    ...
    $(document).on('click', '.modal_uji_koneksi', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingPacs/FormUjiKoneksi.php',
            data        : {id_connection_pacs: id_connection_pacs},
            success     : function(data){
    ...
    $(document).on('click', '.modal_edit', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingPacs/FormEdit.php',
            data        : {id_connection_pacs: id_connection_pacs},
            success     : function(data){
                $('#FormEdit').html(data);
            }
    ...
    $('#ProsesEdit').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/SettingPacs/ProsesEdit.php',
            dataType: 'json',
            data    : ProsesEdit,
            success: function(response) {
                var status  = response.status;
    ...
    $(document).on('click', '.modal_delete', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingPacs/FormDelete.php',
            data        : {id_connection_pacs: id_connection_pacs},
            success     : function(data){
    ...
    $('#ProsesDelete').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/SettingPacs/ProsesDelete.php',
            dataType: 'json',
            data    : ProsesDelete,
            success: function(response) {
                var status  = response.status;
