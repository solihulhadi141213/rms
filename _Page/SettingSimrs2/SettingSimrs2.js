...
function ShowConnectionTable() {
    $.ajax({
        type    : 'POST',
        url     : '_Page/SettingSimrs2/TabelSettingSimrs2.php',
...
$(document).ready(function() {
    ...
    */
    ...
    $('#ProsesTambah').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/SettingSimrs2/ProsesTambah.php',
            dataType: 'json',
            data    : ProsesTambah,
    ...
    $(document).on('click', '.modal_detail', function () {
        ...
        //tangkap data 'id_connection_simrs_old' dan buat variabel
        var id_connection_simrs_old   = $(this).data('id');
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingSimrs2/FormDetail.php',
            data        : {id_connection_simrs_old: id_connection_simrs_old},
            success     : function(data){
    ...
    $(document).on('click', '.modal_uji_koneksi', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingSimrs2/FormUjiKoneksi.php',
            data        : {id_connection_simrs_old: id_connection_simrs_old},
            success     : function(data){
    ...
    $(document).on('click', '.modal_edit', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingSimrs2/FormEdit.php',
            data        : {id_connection_simrs_old: id_connection_simrs_old},
            success     : function(data){
                $('#FormEdit').html(data);
            }
    ...
    $('#ProsesEdit').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/SettingSimrs2/ProsesEdit.php',
            dataType: 'json',
            data    : ProsesEdit,
            success: function(response) {
                var status  = response.status;
    ...
    $(document).on('click', '.modal_delete', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingSimrs2/FormDelete.php',
            data        : {id_connection_simrs_old: id_connection_simrs_old},
            success     : function(data){
    ...
    $('#ProsesDelete').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/SettingSimrs2/ProsesDelete.php',
            dataType: 'json',
            data    : ProsesDelete,
            success: function(response) {
                var status  = response.status;
