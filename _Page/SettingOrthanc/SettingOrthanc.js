...
function ShowConnectionTable() {
    $.ajax({
        type    : 'POST',
        url     : '_Page/SettingOrthanc/TabelConnection.php',
...
$(document).ready(function() {
    ...
    */
    ...
    $('#ProsesTambah').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/SettingOrthanc/ProsesTambah.php',
            dataType: 'json',
            data    : ProsesTambah,
            success: function(response) {
                ...
                if(status=='success'){
                    ...
                    Swal.fire(
                        'Success!',
                        'Tambah Koneksi Orthanc Berhasil!',
                        'success'
                    )
    ...
    $(document).on('click', '.modal_detail', function () {
        ...
        //tangkap data 'id_connection_orthanc' dan buat variabel
        var id_connection_orthanc   = $(this).data('id');
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingOrthanc/FormDetail.php',
            data        : {id_connection_orthanc: id_connection_orthanc},
            success     : function(data){
    ...
    $(document).on('click', '.modal_uji_koneksi', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingOrthanc/FormUjiKoneksi.php',
            data        : {id_connection_orthanc: id_connection_orthanc},
            success     : function(data){
    ...
    $(document).on('click', '.modal_edit', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingOrthanc/FormEdit.php',
            data        : {id_connection_orthanc: id_connection_orthanc},
            success     : function(data){
                $('#FormEdit').html(data);
            }
    ...
    $('#ProsesEdit').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/SettingOrthanc/ProsesEdit.php',
            dataType: 'json',
            data    : ProsesEdit,
            success: function(response) {
                var status  = response.status;
    ...
    $(document).on('click', '.modal_delete', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/SettingOrthanc/FormDelete.php',
            data        : {id_connection_orthanc: id_connection_orthanc},
            success     : function(data){
    ...
    $('#ProsesDelete').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/SettingOrthanc/ProsesDelete.php',
            dataType: 'json',
            data    : ProsesDelete,
            success: function(response) {
                var status  = response.status;
                ...
                if(status=='success'){
                    ...
                    Swal.fire(
                        'Success!',
                        'Hapus Koneksi Orthanc Berhasil!',
                        'success'
                    )
                }else{
