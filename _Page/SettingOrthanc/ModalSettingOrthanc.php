        ...
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesTambah" autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="name_connection_orthanc">
                                <small>Nama Koneksi</small>
                            </label>
                            <input type="text" class="form-control" name="name_connection_orthanc" id="name_connection_orthanc" required>
                            <small>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="url_connection_orthanc">
                                <small>URL Orthanc</small>
                            </label>
                            <input type="url" class="form-control" name="url_connection_orthanc" id="url_connection_orthanc" placeholder="https://" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="username_connection_orthanc">
                                <small>Username Orthanc</small>
                            </label>
                            <input type="text" class="form-control" name="username_connection_orthanc" id="username_connection_orthanc" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="password_connection_orthanc">
                                <small>Password Orthanc</small>
                            </label>
                            <input type="text" class="form-control" name="password_connection_orthanc" id="password_connection_orthanc" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="status_connection_orthanc">
                                <small>Status Connetion</small>
                            </label>
                            <select name="status_connection_orthanc" id="status_connection_orthanc" class="form-control">
