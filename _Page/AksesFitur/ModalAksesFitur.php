                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8">
                            <select name="OrderBy" id="OrderBy" class="form-control">
                                ...
                                <option value="feature_name">Nama Fitur</option>
                                <option value="feature_category">Kategori</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8">
                            <select name="KeywordBy" id="KeywordBy" class="form-control">
                                ...
                                <option value="feature_name">Nama Fitur</option>
                                <option value="feature_category">Kategori</option>
                                <option value="id_access_feature">ID Fitur</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesTambahFitur" autocomplete="off">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-rounded" id="TombolTambahFitur">
