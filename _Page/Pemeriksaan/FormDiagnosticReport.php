<?php
    ...
    echo '
        ...
        <div class="row mb-2 mt-3">
            <div class="col-12">
                <h6 class="border-bottom pb-2 text-primary">A. Informasi Umum <i>Diagnostic Report</i></h6>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-4">
    ...
    echo '
        <div class="row mb-2 mt-3">
            <div class="col-12">
                <h6 class="border-bottom pb-2 text-primary">B. Kategori</h6>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-4">
    ...
    echo '
        <div class="row mb-2 mt-3">
            <div class="col-12">
                <h6 class="border-bottom pb-2 text-primary">D. Service Request</h6>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-4">
    ...
    echo '
        <div class="row mb-2 mt-3">
            <div class="col-12">
                <h6 class="border-bottom pb-2 text-primary">E. Permintaan Pemeriksaan</h6>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-4">
