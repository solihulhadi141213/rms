            ...
            <div class="col-md-12">
                <form action="javascript:void(0);" id="ProsesUpdateCompany">
                    <div class="card">
                        <div class="card-header">
                            <b class="card-title">
                                <i class="bi bi-building"></i> Profil Faskes
                            </b>
                        </div>
                        <div class="card-body">
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3">
                                    <label for="company_code">
                                        <small>Kode Faskes</small>
                                    </label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="company_code" id="company_code" value="<?php echo "$company_code"; ?>">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-md-3">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-md btn-primary btn-rounded">
                                <i class="bi bi-upload"></i> Update Pengaturan
                            </button>
                        </div>
                    </div>
                </form>
