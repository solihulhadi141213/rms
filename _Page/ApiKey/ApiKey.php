<?php
    ...
    $IjinAksesSaya=IjinAksesSaya($Conn,$SessionIdAccess,'nkYXm3U8XWpOt1cD3PNeCwDQzesMYmmUUbee');
...
?>
    <div class="pagetitle">
        <h1>
            <a href="">
                <i class="bi bi-plug"></i> API Key</a>
            </a>
        </h1>
        <nav>
            <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <small>
                        Berikut ini adalah halaman untuk mengelola akun API yang berfungsi sebagai parameter aplikasi lain agar dapat terhubung dengan Radix. 
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-12 text-end">
                                <button type="button" class="btn btn-md btn-primary btn-floating modal_tambah" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Tambah API Key">
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="text-left"><b><small>Duration</small></b></td>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-12">
                                <small>
                                    Keterangan : <span class="text text-muted">Password tidak akan ditampilkan karena dienkripsi satu arah dengan <code>PASSWORD_DEFAULT</code></span>
                                </small>
                            </div>
                        </div>
                    </div>
